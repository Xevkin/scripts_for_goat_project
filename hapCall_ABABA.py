...
DFO = ( nBABAA + nBBBAA + nABABA + nAAABA - (nBAABA + nBBABA + nABBAA + nAABAA) ) / ( nBABAA + nBBBAA + nABABA + nAAABA + (nBAABA + nBBABA + nABBAA + nAABAA) )

DIL = ( nABBAA + nBBBAA + nBAABA + nAAABA - (nABABA + nBBABA + nBABAA + nAABAA) ) / ( nABBAA + nBBBAA + nBAABA + nAAABA + (nABABA + nBBABA + nBABAA + nAABAA) )

DFI = ( nBABAA + nBABBA + nABABA + nABAAA - (nABBAA + nABBBA + nBAABA + nBAAAA) ) / ( nBABAA + nBABBA + nABABA + nABAAA + (nABBAA + nABBBA + nBAABA + nBAAAA) )

DOL = ( nBAABA + nBABBA + nABBAA + nABAAA - (nABABA + nABBBA + nBABAA + nBAAAA) ) / ( nBAABA + nBABBA + nABBAA + nABAAA + (nABABA + nABBBA + nBABAA + nBAAAA) )
