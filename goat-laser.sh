...
python2 $LASER_PILEUP_PY -f ${REF} -m ${DATASET_PATH}${DATASET}.site -b ${DATASET_PATH}${DATASET}.bed -o ${DATASETNAME}_${OUTNAME} *_${DATASETNAME}.pileup ${PILEUPS_PATH}*_${DATASETNAME}.pileup ${EXTRA_PILEUP_PATH}*_${DATASETNAME}.pileup
...
sed -f /home/kdaly/programs/scripts_for_goat_project/fix_sheep.sed ${DATASETNAME}_${OUTNAME}.RefPC.coord > tmp1 && mv tmp1 ${DATASETNAME}_${OUTNAME}.RefPC.coord

sed -f /home/kdaly/programs/scripts_for_goat_project/fix_sheep.sed ${DATASETNAME}_${OUTNAME}.SeqPC.coord > tmp1 && mv tmp1  ${DATASETNAME}_${OUTNAME}.SeqPC.coord
